...
data=[['Logistic Regression',
      ...
      ['Decision Tree', str(calcAccuracycDS1(1))+'%', str(calcAccuracycDS2(1))+'%', str(calcAccuracycDS3(1))+'%', str(calcAccuracyDS4(1)) + ' %'],
      ['Random Forest', str(calcAccuracycDS1(2))+'%', str(calcAccuracycDS2(2))+'%', str(calcAccuracycDS3(2))+'%', str(calcAccuracyDS4(2)) + ' %'],
      ['Linear SVR', str(calcAccuracycDS1(3))+'%', str(calcAccuracycDS2(3))+'%', str(calcAccuracycDS3(3))+'%', str(calcAccuracyDS4(3)) + ' %'],
      ['Gradient Boosting', str(calcAccuracycDS1(4))+'%', str(calcAccuracycDS2(4))+'%', str(calcAccuracycDS3(4))+'%', str(calcAccuracyDS4(4)) + ' %']]
